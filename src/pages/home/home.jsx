...
import popeImg2x from "../../assets/img/pope-francis.@2x.png";
    ...
    <div className="home">
      ...
      <header className="hero">
          <img
              ...
              srcSet={`${popeImg} 750w, ${popeImg2x} 1440w`}
      ...
      <div className="max-centered">
          ...
          <main role="main">
              ...
              <Text className="text" >My code goes her </Text>
              <Selector />
              <Button className="card__vote">Vote Now</Button>
              <Button className="card__icon-button" ariaLabel="thumbs up">
                <img src={thumbsUp} alt="thumbs up" />
              </Button>
              <Button className="card__icon-button" ariaLabel="thumbs down">
                <img src={thumbsDown} alt="thumbs down" />
              </Button>
              {/* End: Implementation */}
          </main>
